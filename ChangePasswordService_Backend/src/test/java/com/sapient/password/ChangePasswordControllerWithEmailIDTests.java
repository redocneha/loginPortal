...
public class ChangePasswordControllerWithEmailIDTests {
...
//	@Autowired
	...
	public void testChangePasswordCase1() throws Exception {
		...
		userToChangePwdService.setEmailID("abc@gmail.com");
		Password password = new Password();
		password.setPwd1("smallWorld");
		password.setPwd2("smallWorld@1");
		userToChangePwdService.setPassword(password);

		User userToDataService = new User();
		userToDataService.setEmailID("abc@gmail.com");

		User userFromDataService = new User(1L, "abc@gmail.com", new Password(2L,
...
//		headers.setContentType(MediaType.APPLICATION_JSON);
		...
		User userToDataServiceAgain = new User(1L, "abc@gmail.com", new Password(2L,
...
//		headers.setContentType(MediaType.APPLICATION_JSON);
	...
	public void testChangePasswordCase3() throws Exception {
		User userToChangePwdService = new User();
		userToChangePwdService.setEmailID("xyz@gmail.com");
		Password password = new Password();
		password.setPwd1("smallWorld");
		password.setPwd2("smallWorld@1");
		userToChangePwdService.setPassword(password);
