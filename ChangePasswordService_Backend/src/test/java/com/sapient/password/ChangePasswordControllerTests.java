 ...
 * ArrayList<User>(); User user1 = new User(); user1.setUserID(1);
 * user1.setOldpwd("smallWorld@1"); //correct pwd
 * user1.sethashedPwd("smallWorld@2"); userList.add(user1);
 * 
 * User user2 = new User(); user1.setUserID(2); user1.setOldpwd("bigWorld");
 * //incorrect pwd user1.sethashedPwd("smallWorld@2"); userList.add(user2);
 * 
 * User user3 = new User(); user1.setUserID(10); //user doesn't exist
 * user1.setOldpwd("peace"); user1.sethashedPwd("peaceWorld");
 * userList.add(user3);
 * 
 ...
 * 
 * @Test public void test_changePasswordWithUserID() throws Exception { String
 * uri = "/api/change"; String inputJson = super.mapToJson(userList.get(0));
 ...
 * 
 * @Test public void test_changePasswordWithUserID_incorrectPwd() throws
 * Exception { String uri = "/api/change"; String inputJson =
 ...
 * 
 * @Test public void test_changePasswordWithUserID_doesnotexist() throws
 * Exception { String uri = "/api/change"; String inputJson =
