 ...
 * 
 * @BeforeClass public static void populateData() { userList = new
 * ArrayList<User>(); userList.add(new User(2, null, "bigWorld@1"));
 * userList.add(new User(3, null, "bigWorld@1")); userList.add(new User(4, null,
 * "bigWorld@1")); userList.add(new User(0, "b@gmail.com", "bigWorld@1"));
 * userList.add(new User(0, "c@gmail.com", "bigWorld@1")); userList.add(new
 * User(0, "d@gmail.com", "bigWorld@1")); }
 * 
 * @Test public void test_authenticateUserWithUserID() throws Exception { String
 * uri = "/api/authenticate"; String inputJson =
 * super.mapToJson(userList.get(0)); MvcResult mvcResult = mvc.perform(
 ...
 * 
 * @Test public void test_authenticateUserWithUserID_wrong() throws Exception {
 * String uri = "/api/authenticate"; String inputJson =
 * super.mapToJson(userList.get(1)); MvcResult mvcResult = mvc.perform(
 * MockMvcRequestBuilders.post(uri).contentType(MediaType.APPLICATION_JSON_VALUE
 * ).content(inputJson)) .andReturn();
 * 
 * int status = mvcResult.getResponse().getStatus(); assertEquals(200, status);
 ...
 * 
 * @Test public void test_authenticateUserWithUserID_doesnotexist() throws
 * Exception { String uri = "/api/authenticate"; String inputJson =
 * super.mapToJson(userList.get(2)); MvcResult mvcResult = mvc.perform(
 * MockMvcRequestBuilders.post(uri).contentType(MediaType.APPLICATION_JSON_VALUE
 * ).content(inputJson)) .andReturn();
 * 
 * int status = mvcResult.getResponse().getStatus(); assertEquals(200, status);
 ...
 * Exception { String uri = "/api/authenticate"; String inputJson =
 * super.mapToJson(userList.get(5)); MvcResult mvcResult = mvc.perform(
 * MockMvcRequestBuilders.post(uri).contentType(MediaType.APPLICATION_JSON_VALUE
 * ).content(inputJson)) .andReturn();
 * 
 * int status = mvcResult.getResponse().getStatus(); assertEquals(200, status);
