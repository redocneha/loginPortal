 ...
 * com.sapient.data.DataRetrievalServiceApplication;
 * 
 * @RunWith(SpringJUnit4ClassRunner.class)
 * 
 * @SpringBootTest(classes = DataRetrievalServiceApplication.class)
 * 
 * @WebAppConfiguration public abstract class AbstractTest { protected MockMvc
 * mvc;
 * 
