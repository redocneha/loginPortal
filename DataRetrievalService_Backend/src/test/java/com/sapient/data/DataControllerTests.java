...
public class DataControllerTests {
	...
	public void testGetUserCase1() throws Exception {
		User expectedUserFromDataService = new User(1L, "abc@gmail.com", new Password(2L,
...
//		assertNotNull(optional);
		...
		assertEquals(expectedUserFromDataService.getPassword().getPwd1(),
				actualUserFromDataService.getPassword().getPwd1());
		assertEquals(expectedUserFromDataService.getPassword().getSalt1(),
				actualUserFromDataService.getPassword().getSalt1());
	...
	public void testUpdateCase1() throws Exception {
		User initialUser = new User(1L, "abc@gmail.com", new Password(2L,
